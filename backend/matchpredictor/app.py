...
from matchpredictor.predictors.poisson_regression_predictor import train_poisson_predictor
from matchpredictor.predictors.poisson_regression_predictor import PoissonRegressionPredictor
...
def build_model_provider(training_data: List[Result]) -> ModelProvider:
    return ModelProvider([
        ...
        Model("Poisson", train_poisson_predictor(training_data)),
